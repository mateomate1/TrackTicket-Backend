...
public class NotificationMapper {
	...
	public static NotificationResponseDTO mapToNotificationResponseDTO(Notification notification) {
		...
		return new NotificationResponseDTO(notification.getMessage(), String.valueOf(notification.getType()),
				notification.isRead(), notification.getNotificationTimestamp());
	}
}
