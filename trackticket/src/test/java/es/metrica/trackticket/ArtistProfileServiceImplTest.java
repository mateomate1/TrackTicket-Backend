...
class ArtistProfileServiceImplTest {
	...
	@Test
	@DisplayName("Tests if service correctly reuses the token if it's not expired")
	void tokenReused() {
		String artist = "Cruz Cafuné";
		String genre = "Rap/HipHop";
		...
		artistProfileService.getArtist(artist, genre);
		artistProfileService.getArtist(artist, genre);
	...
	@Test
	@DisplayName("Tests if service correctly throws IllegalArgumentException if artistName is null or blank")
	void iaeThrownNoArtist() {
		Exception blankException = assertThrows(IllegalArgumentException.class,
				() -> artistProfileService.getArtist("", "genre"));
		Exception nullException = assertThrows(IllegalArgumentException.class,
				() -> artistProfileService.getArtist(null, "genre"));

		assertEquals("El nombre del artista no puede estar vacío.", blankException.getMessage());
		assertEquals("El nombre del artista no puede estar vacío.", nullException.getMessage());
	}

	@Test
	@DisplayName("Tests if service correctly throws ResourceNotFoundException if artist is not found")
	void rnfeThrownNoArtist() {
		...
		Exception e = assertThrows(ResourceNotFoundException.class,
				() -> artistProfileService.getArtist("Cruz Cafuné", "genre"));

		assertEquals("No se encuentran resultados para ese artista.", e.getMessage());
	}
	
	@Test
	@DisplayName("Tests if service makes the correct call when introducing a valid artist name but no albums found.")
	void getArtistNoAlbums() {
		String artist = "Cruz Cafuné";
		String genre = "Rap/HipHop";
	...
	@Test
	@DisplayName("Tests if service makes the correct call when introducing a valid artist name when no playlists are found.")
	void getArtistNoPlaylists() {
		String artist = "Cruz Cafuné";
		String genre = "Rap/HipHop";
	...
	@Test
	@DisplayName("Tests if service makes the correct call when introducing a valid artist name and all playlist items are null.")
	void getArtistWhenNullPlaylists() {
		String artist = "Cruz Cafuné";
		String genre = "Rap/HipHop";
